    ...
    <div className="flex w-full min-h-screen">
      ...
      <div className="table-container w-[100%] p-2">
          ...
          <div className="container flex justify-center items-center">
            ...
            <img src={`https://hanibackendapp.onrender.com/${state?.product?.photoPaths}`} className=" border border-white  hover:border-2 hover:border-white  w-[40%] h-[30%]" alt="logo" />
            </div>
            ...
            <div>
            <div className="border-b border-black">"{state?.product?.remark}"</div>
            </div>
            </div>
